...
-- ============================================
-- 3. تحديث جدول المنتجات (inventory_items)
-- ============================================

-- التأكد من وجود جميع الحقول المطلوبة
ALTER TABLE inventory_items
ADD COLUMN IF NOT EXISTS code TEXT, -- كود المنتج
...
-- ============================================
-- 7. إنشاء View لتقارير الواردات والصادرات
-- ============================================
...
-- ============================================
-- 8. إنشاء Function لحساب المخزون الحالي
-- ============================================
...
-- ============================================
-- 9. إنشاء Trigger للتنبيه التلقائي عند انخفاض المخزون
-- ============================================
...
-- ============================================
-- 10. إنشاء Function لإعادة تعيين حالة التنبيه
-- ============================================
